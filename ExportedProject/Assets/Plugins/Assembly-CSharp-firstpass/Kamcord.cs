...
public class Kamcord : MonoBehaviour
{
	...
	public delegate void AndroidWhitelistFinalized();

	public delegate void IsEnabledChanged(bool isEnabled);

	private bool enableIOS = true;

	private bool enableAndroid;
	...
	public static event AndroidWhitelistFinalized androidWhitelistFinalized;
	...
	public static void UnsubscribeFromAllCallbacks()
	{
		...
		Kamcord.androidWhitelistFinalized = null;
	...
	public static void CallAndroidWhitelistFinalized()
	{
		if (Kamcord.androidWhitelistFinalized != null)
		{
			Kamcord.androidWhitelistFinalized();
		}
	}
	...
	private void _KamcordWhitelistFinalized(string empty)
	{
		CallAndroidWhitelistFinalized();
	}
}
