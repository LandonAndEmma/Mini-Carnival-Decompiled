...
public class TUISelfAdaptiveAnchor_OnlyY : MonoBehaviour
{
	...
	public static void CastAnchor(TUICamera tCamera, Transform transform, bool lock568x384 = true)
	{
		...
		transform.localPosition = new Vector3(transform.localPosition.x, transform.localPosition.y * one.y, transform.localPosition.z * one.z);
	}
}
