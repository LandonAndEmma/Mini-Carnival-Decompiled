...
public class TUIPageEx : TUIControlImpl
{
	...
	{
		base.gameObject.SampleAnimation(clipForward, clipForward.length * timePercent);
	}

	public void TrackBackward(float timePercent)
	{
		base.gameObject.SampleAnimation(clipBackward, clipBackward.length * timePercent);
	}
