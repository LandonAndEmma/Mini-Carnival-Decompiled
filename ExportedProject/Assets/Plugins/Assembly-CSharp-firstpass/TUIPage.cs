...
public class TUIPage : TUIControlImpl
{
	...
	private void Start()
	{
		...
		AnimationClip clip = base.animation[GetAnimationName(AnimationFlag.ForwardBringIn)].clip;
		...
		clip = base.animation[GetAnimationName(AnimationFlag.ForwardDismiss)].clip;
		animationEvent.functionName = "DoWhenAnimationEnd";
		animationEvent.time = clip.length;
		clip.AddEvent(animationEvent);
		...
		clip.AddEvent(animationEvent2);
		animationEvent = new AnimationEvent();
		clip = base.animation[GetAnimationName(AnimationFlag.BackBringIn)].clip;
		animationEvent.functionName = "DoWhenAnimationEnd";
		animationEvent.time = clip.length;
		clip.AddEvent(animationEvent);
		animationEvent2 = new AnimationEvent();
		...
		clip.AddEvent(animationEvent2);
		animationEvent = new AnimationEvent();
		clip = base.animation[GetAnimationName(AnimationFlag.BackDismiss)].clip;
		animationEvent.functionName = "DoWhenAnimationEnd";
		animationEvent.time = clip.length;
		clip.AddEvent(animationEvent);
		animationEvent2 = new AnimationEvent();
