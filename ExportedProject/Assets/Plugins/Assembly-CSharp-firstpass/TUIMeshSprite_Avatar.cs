...
[AddComponentMenu("TUI/Control/Mesh Sprite Avatar")]
[RequireComponent(typeof(MeshRenderer))]
[ExecuteInEditMode]
[RequireComponent(typeof(MeshFilter))]
public class TUIMeshSprite_Avatar : TUINeedUpdateBase
{
	[SerializeField]
	...
	protected virtual void UpdateMesh()
	{
		...
		if (useCustomize)
		{
			...
			{
				customizeMaterial = new Material(Shader.Find("Triniti/Particle/AB_COL_DO_ZTA"));
			}
