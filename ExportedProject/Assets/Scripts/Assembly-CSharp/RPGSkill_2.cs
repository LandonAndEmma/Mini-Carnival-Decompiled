...
public class RPGSkill_2 : RPGSkill_GenerateBuff
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[2];
	}
	...
	public override float ActiveSkill()
	{
		...
		RPGTBuff rPGTBuff = GenerateBuff(obj, "RPGBuff_FirstAction", 102, false);
		float fLen = 0f;
