...
public class UI_WaitingBox : MonoBehaviour
{
	...
	private void Start()
	{
		nIndex = 0;
		_fCurTime = Time.time;
		_icon.texture = _frameIcons[nIndex];
		if (_bAutoStart)
		{
			StartWaiting(new Vector2(0f, -12f));
		}
	}
	...
	public void StartWaiting(Vector2 pos, Vector2 coverArear, float fIntervalTime)
	{
		...
		base.transform.position = new Vector3(pos.x, pos.y, -400f);
		TUIBlock component = GetComponent<TUIBlock>();
		if (component != null)
		{
			component.size = coverArear;
		}
	}
