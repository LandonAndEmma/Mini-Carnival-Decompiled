...
public class UI_ButtonEnhanceClick : UIEntity
{
	[SerializeField]
	private GameObject _enhanceBtns;
	...
	private void OnClick()
	{
		...
		if (COMA_Pref.Instance.NG2_1_FirstEnterSquare && UIDataBufferCenter.Instance.CurNGIndex == 4)
		{
			UIMessageDispatch.Instance.SendMessage(EUIMessageID.UING_SquareChangeBoard, null, 0);
		}
		_enhanceBtns.SetActive(true);
	}
}
