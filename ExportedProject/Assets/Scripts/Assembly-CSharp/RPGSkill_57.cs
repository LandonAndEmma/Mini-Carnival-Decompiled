...
public class RPGSkill_57 : RPGSkill_GenerateBuff
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[57];
	}
	...
	public override float ActiveSkill()
	{
		...
		rPGBuff_Revenant._durBout = (int)base.SkillUnit.ParamLst[3];
