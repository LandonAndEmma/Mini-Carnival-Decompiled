...
public class RPGSkill_14 : RPGSkill_GenerateBuff
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[14];
	}
	...
	public override float ActiveSkill()
	{
		...
		RPGTBuff rPGTBuff = GenerateBuff(obj, "RPGBuff_Builder", 112, false);
