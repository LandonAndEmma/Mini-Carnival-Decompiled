...
[ExecuteInEditMode]
public class UIAnchor_PopPrefab : MonoBehaviour
{
	public enum Side
	{
		BottomLeft = 0,
	...
	private void Start()
	{
		...
		if (uiCamera == null)
		{
			uiCamera = base.transform.parent.parent.parent.parent.gameObject.GetComponent<Camera>();
		}
		if (uiCamera == null && _prefabRoot != null)
		{
			uiCamera = _prefabRoot.parent.parent.parent.gameObject.GetComponent<Camera>();
		}
		Update();
	}
