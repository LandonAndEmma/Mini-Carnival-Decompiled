	...
	public class DeflaterOutputStream : Stream
	{
		...
		public virtual void Finish()
		{
			...
			if (cryptoTransform_ != null)
			{
				...
				{
					AESAuthCode = ((ICSharpCode.SharpZipLib.Encryption.ZipAESTransform)cryptoTransform_).GetAuthCode();
				}
		...
		protected void InitializeAESPassword(ZipEntry entry, string rawPassword, out byte[] salt, out byte[] pwdVerifier)
		{
			...
			cryptoTransform_ = new ICSharpCode.SharpZipLib.Encryption.ZipAESTransform(rawPassword, salt, blockSize, true);
			pwdVerifier = ((ICSharpCode.SharpZipLib.Encryption.ZipAESTransform)cryptoTransform_).PwdVerifier;
		}
