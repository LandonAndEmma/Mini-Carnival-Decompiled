...
namespace ICSharpCode.SharpZipLib.Zip
{
	public class ExtendedUnixData : ITaggedData
	{
		...
		public void SetData(byte[] data, int index, int count)
		{
			...
			{
				using (ICSharpCode.SharpZipLib.Zip.ZipHelperStream zipHelperStream = new ICSharpCode.SharpZipLib.Zip.ZipHelperStream(stream))
				{
		...
		public byte[] GetData()
		{
			...
			{
				using (ICSharpCode.SharpZipLib.Zip.ZipHelperStream zipHelperStream = new ICSharpCode.SharpZipLib.Zip.ZipHelperStream(memoryStream))
				{
