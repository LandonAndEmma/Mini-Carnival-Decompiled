...
public class RPGSkill_49 : RPGSkill_GenerateBuff
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[49];
	}
	...
	public override float ActiveSkill()
	{
		...
		RPGTBuff rPGTBuff = GenerateBuff(obj, "RPGBuff_AddHp", 106, false);
