...
public class UIRankings_ButtonWorldGameModeType : MonoBehaviour
{
	[SerializeField]
	...
	private void OnClick()
	{
		...
		if (base.name == "00_Avatar")
		{
			UIMessageDispatch.Instance.SendMessage(EUIMessageID.UIRankings_WorldGameModeSelChanged, null, 901, base.gameObject);
		}
		else
		{
			UIMessageDispatch.Instance.SendMessage(EUIMessageID.UIRankings_WorldGameModeSelChanged, null, CurType, base.gameObject);
		}
	}
}
