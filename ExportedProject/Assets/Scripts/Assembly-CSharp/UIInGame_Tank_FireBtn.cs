...
public class UIInGame_Tank_FireBtn : TUIButton
{
	...
	private Vector2 vLastMove = Vector2.zero;
	...
	public override bool HandleInput(TUIInput input)
	{
		...
		if (input.inputType == TUIInputType.Began)
		{
			...
			{
				m_JoyStickObj.renderer.material.color = new Color(1f, 1f, 1f, 1f);
				m_bPressed = true;
		...
		else if (input.fingerId == m_iFingerId)
		{
			...
			{
				m_JoyStickObj.renderer.material.color = new Color(1f, 1f, 1f, 0.5f);
				m_bPressed = false;
				m_iFingerId = -1;
			...
			{
				PostEvent(this, 4, vLastMove.x, vLastMove.y, null);
			}
		}
		return false;
	}
	...
	{
		Object.DestroyImmediate(m_JoyStickObj.renderer.material);
	}
}
