...
public class RPGSkill_13 : RPGSkill_GenerateBuff
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[13];
	}
	...
	public override float ActiveSkill()
	{
		...
		float fLen = 0f;
		if (_skillOwner.AddBuff(rPGBuff_WindUpWarrior, true, ref fLen, _skillOwner) != -1f)
		{
