...
public class RPGSkill_3 : RPGSkill_GenerateBuff
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[3];
	}
	...
	public override float ActiveSkill()
	{
		...
		RPGTBuff rPGTBuff = GenerateBuff(obj, "RPGBuff_PerfectAccuracy", 103, false);
		float fLen = 0f;
