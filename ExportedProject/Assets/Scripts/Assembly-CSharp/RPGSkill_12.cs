...
public class RPGSkill_12 : RPGTSkill
{
	private void Awake()
	{
		_skillUnit = RPGGlobalData.Instance.SkillUnitPool._dict[12];
	}
	...
	public override void Skill_InitAttackCount(RPGCenterController_Auto controller)
	{
		...
		controller._attackCount = 0;
		controller._curAttackCount = 0;
		controller._extraATTCount = num - 1;
